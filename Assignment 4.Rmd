...
#set seed dor using Sample data:
```{r}
set.seed(1)
```

#attach in Default variable:
```{r}
attach(Default)
```

#using multiple logistic refression:
```{r}
...
#ANS:-using boostrap function in find the Boostrap statistics value of bias and std.error

 (d) Comment on the estimated standard errors obtained using the glm() function and using your bootstrap function.
 
#ANS:The standard errors acquired using the glm() function are "4.348e-01, 4.985e-06, and 2.274e-04", those obtained using the bootstrap function are "4.344722e-01, 2.298949e-04, and 4.866284e-06".

#ANS:- he estimated standard errors obtained using glm() function and using boostrap function find the income and balance  2.081e-05 and 5.647e-03 
